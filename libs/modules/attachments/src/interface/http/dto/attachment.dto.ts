...
export const AttachmentResponseSchema = z.object({
  id: z.string().uuid(),
  /** The subject this file hangs off (0083; `test_case` Phase 7 Phase C, `test_result` Phase E). Replaced `workItemId`. */
  entityType: z.enum(['work_item', 'portfolio_item', 'test_case', 'test_result']),
